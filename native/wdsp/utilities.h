...
PORT void print_buffer_parameters (const char* filename, int channel);
...
extern PORT int create_bfcu(int id, int min_size, int max_size, double rate, double corner, int points);

extern PORT void destroy_bfcu(int id);

extern PORT void getFilterCorners(int id, int* lower_index, int* upper_index);

extern PORT void getFilterCurve(int id, int size, int w_type, int index_low, int index_high, double* segment);
