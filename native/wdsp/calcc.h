...
typedef struct _calcc
{
	...
	double* temptx;				//////////////////////////////////////////////////// temporary tx complex buffer for psccF compatibility
	double* temprx;				//////////////////////////////////////////////////// temporary rx complex buffer for psccF compatibility
...
extern PORT void pscc (int channel, int size, double* tx, double* rx);
