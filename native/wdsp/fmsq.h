...
extern PORT void SetRXAFMSQThreshold (int channel, double threshold);

extern PORT void SetRXAFMSQNC (int channel, int nc);

extern PORT void SetRXAFMSQMP (int channel, int mp);
